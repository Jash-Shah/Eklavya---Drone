#include <algorithm>
#include <assert.h>
#include "drone/gazebo_edrone_propulsion.h"
...
namespace gazebo
{
  ...
  //*****************************************************************************************************************************************************************************  
    ...
    ros::SubscribeOptions so = ros::SubscribeOptions::create<drone::prop_speed>(
      this->topic_name_,1,
  ...
  void ModelJointControler::OnRosMsg_prop_speed(const drone::prop_speedConstPtr &_msg)
  {
