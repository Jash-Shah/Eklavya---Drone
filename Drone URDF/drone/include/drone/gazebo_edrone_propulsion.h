...
class ModelJointControler : public ModelPlugin
{
  ...
  private: void OnRosMsg_prop_speed(const drone::prop_speedConstPtr &_msg);
  ...
  private: drone::prop_speed force_msg_;
  private: drone::prop_speed temp_msg_;
